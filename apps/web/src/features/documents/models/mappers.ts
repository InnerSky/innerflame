...
export function mapEntityToDocument(
  entity: Tables<"documents">,
  currentVersion?: Tables<"document_versions">
): Document {
  return {
...
export function mapEntityVersionToDocumentVersion(
  version: Tables<"document_versions">
): DocumentVersion {
...
export function mapDocumentToEntity(document: Document): Partial<Tables<"documents">> {
  return {
    id: document.id,
