      ...
      <AnimatedSection>
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <ul className="mb-6 list-disc pl-6 space-y-1">
            ...
            <li>Impersonate real documents or create fake personas to falsely attribute content or mislead others about its origin without consent or legal right</li>
          ...
          <ul className="mb-6 list-disc pl-6 space-y-1">
            ...
            <li>Engage in campaigns, including political campaigns, that promote false or misleading information to discredit or undermine individuals, groups, documents or institutions</li>
          ...
          <ul className="mb-6 list-disc pl-6 space-y-1">
            ...
            <li>Facilitate or provide account access to InnerFlame to persons or documents who are located in unsupported locations</li>
